...
no element of arr1 should be added to the resulting array. If either arr1 or arr2 is empty,
you should return an empty arr (empty list in python, empty vector in c++).
...
function findArray(arr1, arr2) {
  ...
  return arr2.map((i) => arr1[i]).filter((el) => el !== undefined);
}
