...
Nevertheless, it is correct in the sense that it eventually produces a sorted version
of the original list when executed to completion.
...
Given an array of integers, your function should return a new array equivalent
