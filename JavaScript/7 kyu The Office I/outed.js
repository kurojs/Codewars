...
and their happiness rating out of 10 as the value, you need to assess the overall
...
function outed(meet, boss) {
  let totalhappiness = Object.values(meet).reduce(
    (total, val) => total + val,
    0,
  );
  if (boss in meet) {
  ...
  return totalhappiness / Object.keys(meet).length <= 5
    ? "Get Out Now!"
    : "Nice Work Champ!";
}
