/*
You get an array of different numbers to sum up. But there is one problem,
those numbers all have different bases. For example:
...
function sumItUp(arr) {
  return arr
    .map(([str, base]) => parseInt(str, base))
