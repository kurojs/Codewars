...
public class Kata {
    public static boolean canPlay(String[] hand, String faceUp) {
        String[] faceUpParts = faceUp.split(" ");
        String faceUpColor = faceUpParts[0];
        String faceUpNumber = faceUpParts[1];
        ...
        for (String card : hand) {
            ...
            if (cardColor.equals(faceUpColor) || cardNumber.equals(faceUpNumber)) {
                return true;             }
        }
