...
Note: Test cases will not extend beyond 100 digits; the first 100 digits of pi
  ...
  int digits;
    ...
    public int calculate() {
            ...
            for (int i = 0; i < digits; i++) {
                int digit = Character.getNumericValue(pi.charAt(i));
                sumOfSquares += digit * digit;
            }
            
            return (int) Math.ceil(Math.sqrt(sumOfSquares));
    }
}
